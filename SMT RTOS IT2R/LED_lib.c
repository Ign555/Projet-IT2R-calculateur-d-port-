...
void Clignotant_Gauche (uint8_t * trame, int debut, int fin)
{
...
void Clignotant_Droit (uint8_t * trame, int debut, int fin)
{
...
void Phares_Off ( uint8_t * trame, int debut, int fin ) {
	
	int i ; 
	
	for (i=debut;i<fin ;i++){
							
		LEDS_set_single_led_color(trame,i,0,0,0,0);
